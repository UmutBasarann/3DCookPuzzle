...
{
    public class GameWonPage : MonoBehaviour, IPage
    {
        #region Event | Action

        public static event Action OnGameWonContinueButtonClicked;
        ...
        {
            if (OnGameWonContinueButtonClicked != null)
            {
                OnGameWonContinueButtonClicked();
            }
        }
